...
var guiGunCraftingTable = new UI.StandartWindow({
	...
	drawing: [
		{type: "bitmap", bitmap: "furnace_bar_background", x: 615, y: 215, scale: guiScale}
	],

	elements: {
		"progressScale": {type: "scale", x: 615, y: 215, direction: 0, value: 0, bitmap: "furnace_bar_scale", scale: guiScale},
		...
		"output": {type: "slot", x: 710, y: 215, size: 90},
		"output0": {type: "slot", x: 800, y: 215, size: 90}
	}
});
...
Translation.addTranslation("Gun Crafting Table", {ru: "Оружейный верстак"});