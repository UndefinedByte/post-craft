...
Callback.addCallback("PostLoaded", function(){
	Recipes.addShaped({id: BlockID.nuclearFurnace, count: 1, data: 0}, ["epe","p p","epe"], ['p',ItemID.plateLead,0,'e',ItemID.ingotLead,0]);
});

//Translations

Translation.addTranslation("Nuclear Furnace", {ru: "Атомная печь"});